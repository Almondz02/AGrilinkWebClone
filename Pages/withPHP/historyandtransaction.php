...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;font-family:'Inter','Segoe UI',system-ui,-apple-system,sans-serif}
    ...
    .profile-menu li:hover{background:var(--surface-hover)}
    ...
    .sidebar-search { display: flex; align-items: center; gap: 10px; background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 12px; padding: 10px 12px; margin: 6px 0 10px; }
    ...
    /* ===== FLOATING CHAT WINDOWS (match homemain.php) ===== */
...
<body>
  ...
  <div class="main-container">
    <div class="main-content">
      <div class="filter-controls">
        ...
        <?php elseif($success):?>
          <div class="alert-success">Filters validated and applied.</div>
        <?php endif; ?>
  ...
  (function(){
    ...
    // ===== HEADER POPUPS (position and toggle) =====
    (function(){
      ...
      function positionNear(el, cont){
        ...
        const bias = 780;
        let left = Math.max(margin, Math.min(window.innerWidth - cw - margin, centerLeft + bias));
