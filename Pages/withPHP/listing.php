...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter','Segoe UI',system-ui,-apple-system,sans-serif; }
    ...
    .profile-container { position: fixed; left: 0; top: 60px; bottom: 0; width: var(--sidebar-expanded); background-color: white; padding: 20px; z-index: 90; box-shadow: 1px 0 5px rgba(0,0,0,0.1); overflow-y:auto; transition: width .3s ease; display:flex; flex-direction:column; }
    ...
    .main-content { flex: 1; margin-left: calc(var(--sidebar-expanded) + 20px); margin-right: 20px; padding: 24px; display: flex; flex-direction: column; gap: 20px; transition: margin-left .3s ease; }
    .container { width: 100%; }
    ...
    <div class="notification-list">
      <div class="notification-item">
        <div class="notification-content">
          <div class="notification-text"><strong>Maria Santos</strong> commented on your listing.</div>
          <div class="notification-time">2 hrs ago</div>
        </div>
      </div>
      <div class="notification-item">
        <div class="notification-content">
          <div class="notification-text"><strong>AgriTech PH</strong> shared a new article.</div>
